-- CreateEnum
CREATE TYPE "BadgeType" AS ENUM ('WORKOUT', 'EXERCISE', 'STREAK');

-- CreateEnum
CREATE TYPE "ExerciseCategory" AS ENUM ('CHEST', 'TRICEPS', 'BICEPS', 'BACK', 'LEGS', 'SHOULDERS', 'ARMS', 'ABS', 'FULL_BODY');

-- CreateEnum
CREATE TYPE "ExerciseType" AS ENUM ('STRENGTH', 'CARDIO', 'MOBILITY', 'FLEXIBILITY');

-- CreateEnum
CREATE TYPE "WorkoutSessionStatus" AS ENUM ('PENDING', 'IN_PROGRESS', 'COMPLETED', 'INCOMPLETE', 'SKIPPED');

-- CreateEnum
CREATE TYPE "GoalType" AS ENUM ('LOSE', 'GAIN', 'MAINTAIN');
...
-- AddForeignKey
ALTER TABLE "my_exercises" ADD CONSTRAINT "my_exercises_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "my_exercises" ADD CONSTRAINT "my_exercises_exerciseId_fkey" FOREIGN KEY ("exerciseId") REFERENCES "exercises"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "exercise_sessions" ADD CONSTRAINT "exercise_sessions_workoutSessionId_fkey" FOREIGN KEY ("workoutSessionId") REFERENCES "workout_sessions"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "exercise_logs" ADD CONSTRAINT "exercise_logs_exerciseSessionId_fkey" FOREIGN KEY ("exerciseSessionId") REFERENCES "exercise_sessions"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "user_streak_logs" ADD CONSTRAINT "user_streak_logs_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "weight_goals" ADD CONSTRAINT "weight_goals_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "weight_logs" ADD CONSTRAINT "weight_logs_goalId_fkey" FOREIGN KEY ("goalId") REFERENCES "weight_goals"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "workout_schedule" ADD CONSTRAINT "workout_schedule_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "workout_schedule" ADD CONSTRAINT "workout_schedule_workoutId_fkey" FOREIGN KEY ("workoutId") REFERENCES "workouts"("id") ON DELETE CASCADE ON UPDATE CASCADE;
