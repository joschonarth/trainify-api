/*
  ...
  - You are about to drop the column `sets` on the `exercises` table. All the data in the column will be lost.
...
INSERT INTO "new_exercises" ("category", "created_at", "id", "is_custom", "name", "type", "user_id") SELECT "category", "created_at", "id", "is_custom", "name", "type", "user_id" FROM "exercises";
